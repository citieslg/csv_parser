...
class Dataschema(models.Model):
    ...
    def get_filter_json(self):
        json_filter = {"state": "stateValue",
        "filters_list": [
                [
                    {"name":"valName", "type":"typeVal", "compairson": "compairsonVal", "values": ()},
                    {"name":"valName", "type":"typeVal", "compairson": "compairsonVal", "values": ()},
                    {"name":"valName", "type":"typeVal", "compairson": "compairsonVal", "values": ()}
                ],
                [
...
class Typestatus(models.Model, JSONMixin):
    STATES = (
        ('a', 'all'),
        ('s', 'soon'),
        ('n', 'now'),
    ...
    name = "typestatus"
    filter_val = "matchestate"


class Typetime(models.Model, JSONMixin):
    STATUS_MATCH = (
        ('n', 'now'),
        ('t', 'time table')
        )
    ...
    name = "typetime"
    filter_val = "match_status"
    value_one = "valfrom"
    value_two = "valto"


class Typescore(models.Model, JSONMixin):
    TOTAL = (
        ('t', 'total'),
        ('h', 'home'),
        ('g', 'guest'),
